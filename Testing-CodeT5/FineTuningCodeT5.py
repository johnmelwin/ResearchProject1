...
You can customize your own training resources by following the HF dataset format to cache it to args.cache_data
Author: Yue Wang
Date: June 2023
"""
...
def main(args):
    ...
    # Load and tokenize resources using the tokenizer from `args.load`. If the resources is already cached, load it from there.
    # You can customize this function to load your own resources for any Seq2Seq LM tasks.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resources-num', default=-1, type=int)
    parser.add_argument('--max-source-len', default=320, type=int)
    parser.add_argument('--max-target-len', default=128, type=int)
    parser.add_argument('--cache-resources', default='cache_data/summarize_python', type=str)
